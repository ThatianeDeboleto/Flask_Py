...
def return_dict():
    #Dicionário para armazenar informações de arquivos de música
    dict_here = [
...
#iniciar um servidor Tornado com HTTPServer.
if __name__ == "__main__":
    port = 5000
    http_server = HTTPServer(WSGIContainer(app))
    logging.debug("Servidor iniciado, por favor visite http://localhost:" + str(port))
